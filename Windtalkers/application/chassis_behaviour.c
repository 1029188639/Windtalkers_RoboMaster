...
static void chassis_infantry_follow_gimbal_yaw_control(fp32 *vx_set, fp32 *vy_set, fp32 *angle_set, chassis_move_t *chassis_move_rc_to_vector)
{
    ...
    {
        swing_angle = 0.0f;
		//swing_angle = -CHASSIS_WZ_RC_SEN * chassis_move_rc_to_vector->chassis_RC->rc.ch[0];
    }
...
static void chassis_no_follow_yaw_control(fp32 *vx_set, fp32 *vy_set, fp32 *wz_set, chassis_move_t *chassis_move_rc_to_vector)
{
    ...
    chassis_rc_to_control_vector(vx_set, vy_set ,chassis_move_rc_to_vector);
		...
		//左旋
    if (chassis_move_rc_to_vector->chassis_RC->key.v & CHASSIS_LEFT_ROTATE_KEY)
    {
        *wz_set = 10.0;
    }
		//右旋
		else if (chassis_move_rc_to_vector->chassis_RC->key.v & CHASSIS_RIGHT_ROTATE_KEY)
    {
        *wz_set = -10.0;
    }	
	...
	{
		  *wz_set = -CHASSIS_WZ_RC_SEN * chassis_move_rc_to_vector->chassis_RC->rc.ch[0];
	}
