...
//底盘摇摆按键
#define SWING_KEY KEY_PRESSED_OFFSET_Z
...
//底盘左右旋转控制按键
#define CHASSIS_RIGHT_ROTATE_KEY KEY_PRESSED_OFFSET_E
#define CHASSIS_LEFT_ROTATE_KEY KEY_PRESSED_OFFSET_Q

//底盘小陀螺控制按键
#define CHASSIS_GRYO_ON_KEY KEY_PRESSED_OFFSET_G
#define CHASSIS_GRYO_OFF_KEY KEY_PRESSED_OFFSET_B
...
//底盘运动过程最大旋转速度
#define NORMAL_MAX_CHASSIS_SPEED_W 1.0f
...
typedef struct
{
  ...
  fp32 vy_min_speed;  //max right speed, unit m/s.右方向最大速度 单位m/s
	fp32 wz_max_speed;  //max letf rotate speed, unit m/s.左方向最大速度 单位m/s
  fp32 wz_min_speed;  //max right rotate speed, unit m/s.右方向最大速度 单位m/s
